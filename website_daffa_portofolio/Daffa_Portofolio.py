...
with m1:
    st.markdown('<div class="stat-box"><div class="stat-number">40+</div><div class="stat-label">Total Data Projects</div></div>', unsafe_allow_html=True)
with m2:
    st.markdown('<div class="stat-box"><div class="stat-number">10</div><div class="stat-label">Enterprise Cases (0 Complaint)</div></div>', unsafe_allow_html=True)
with m3:
